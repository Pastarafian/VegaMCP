...
const VPS_CONFIG = {
  host: process.env.VPS_HOST || 'REDACTED_IP',
...
"`;
    ...
    return ok({ error: e.message, hint: 'Check VPS connectivity. SSH to REDACTED_IP:22' });
  }
}
