...
export function entityLink(entityName: string): ResourceLink {
  return {
    uri: `REDACTED://entities/${encodeURIComponent(entityName)}`,
    name: entityName,
...
export function observationsLink(entityName: string): ResourceLink {
  return {
    uri: `REDACTED://entities/${encodeURIComponent(entityName)}/observations`,
...
export function taskLink(taskId: string): ResourceLink {
  return {
    uri: `REDACTED://swarm/tasks/${taskId}`,
    name: `Task ${taskId}`,
