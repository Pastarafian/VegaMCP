...
export const mcpAppsSchema = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      entities: { type: 'array', items: { type: 'object' }, description: 'Entities for graph visualization' },
      relations: { type: 'array', items: { type: 'object' }, description: 'Relations for graph visualization' },
      agents: { type: 'array', items: { type: 'object' }, description: 'Agents for swarm monitor' },
      tasks: { type: 'array', items: { type: 'object' }, description: 'Tasks for swarm monitor' },
