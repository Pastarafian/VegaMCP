...
// In MarkdownV2, expanding block quote is `**>` followed by lines.
// And we must escape punctuation if it's not part of markup.
sendTg('Test MarkdownV2 expand:\n**> This is an expandable blockquote\n**> Line 2\n\nNormal text\\.', 'MarkdownV2');
